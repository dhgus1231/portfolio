...
export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-slate-900 to-slate-700 text-white py-16 px-8 print:bg-white print:text-slate-900 print:py-6 print:border-b-2 print:border-slate-800">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            {/* 텍스트 */}
            <div>
              <h1 className="text-5xl font-bold tracking-tight print:text-3xl print:text-slate-900">{profile.name}</h1>
              <p className="text-slate-300 text-lg mt-1 print:text-slate-500">{profile.nameEn}</p>
